...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`(){
        ...
        val writeValueAsString:String = objectMapper.writeValueAsString(customerDto)

        mockMvc.perform(MockMvcRequestBuilders.post(URL).contentType(MediaType.APPLICATION_JSON)
            .content(writeValueAsString))
            .andExpect(MockMvcResultMatchers.status().isCreated)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Débora"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("debora@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da Silva, 123"))
    ...
    fun `should find a customer by id and return 200 status`(){
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("$URL/${customer.id}")
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Debora"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Silva"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("debora@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
    ...
    @Test
    fun `should not find customer whith invalid and return 400 status`(){
    ...
    fun `should update customer and return 200`(){
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("DebUpdate"))
    ...
    private fun builderCustomerDto(
        firstName: String = "Débora",
        lastName: String = "Silva",
        cpf: String = "28475934625",
        email: String = "debora@email.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "1234",
        zipCode: String = "000000",
        street: String = "Rua da Silva, 123",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
